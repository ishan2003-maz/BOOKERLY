...
import styles from "../../../../../styles/events/sports/football/page.module.css";
  ...
  return (
    <>
      ...
      <div className={styles.flexRow}>
        ...
        <h1 className={styles.heading}>ATK Mohun Bagan vs Kerala Blasters - ISL</h1>
          <img src="/football.jpg" alt="Football Match" className={styles.img} />
        </div>

        <section className={styles.details}>
          <p><strong><CiCalendar size={25}style={{ verticalAlign: "middle", marginRight: "6px" }}/></strong> 2 Aug, 2025</p>
          <p><strong><IoTimeOutline size={25}style={{ verticalAlign: "middle", marginRight: "6px" }} /></strong> 7:00 PM</p>
          <p><strong><GiDuration size={25}style={{ verticalAlign: "middle", marginRight: "6px" }} /></strong> 2hrs</p>
          <p><strong><LiaLanguageSolid size={25}style={{ verticalAlign: "middle", marginRight: "6px" }}/></strong> Bengali, English</p>
          <p><strong><CiLocationOn size={25}style={{ verticalAlign: "middle", marginRight: "6px" }}/></strong> Salt Lake Stadium, Kolkata</p>
          <p><span className={styles.price}>₹599</span></p>
          <MovieBookingModal
            movieTitle="ATK Mohun Bagan vs Kerala Blasters - ISL"
            dates={["Sat 2 Aug 2025", "Sun 3 Aug 2025"]}
